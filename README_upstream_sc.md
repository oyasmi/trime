...
[English](README_upstream.md) | 简体中文 | [繁體中文](README_upstream_tc.md)

> **说明**：这是上游项目 [osfans/trime](https://github.com/osfans/trime) 的原始 README，原样保留。
> 本 fork 在其基础上做了哪些增强，请看 [README_sc.md](README_sc.md)。
