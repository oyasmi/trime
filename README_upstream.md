...
English | [简体中文](README_upstream_sc.md) | [繁體中文](README_upstream_tc.md)

> **Note**: this is the original README of the upstream project [osfans/trime](https://github.com/osfans/trime), kept here unmodified.
> For what this fork adds on top of it, see [README.md](README.md).
