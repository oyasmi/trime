...
[English](README_upstream.md) | [简体中文](README_upstream_sc.md) | 繁體中文

> **說明**：這是上游專案 [osfans/trime](https://github.com/osfans/trime) 的原始 README，原樣保留。
> 本 fork 在其基礎上做了哪些增強，請看 [README_tc.md](README_tc.md)。
